...
<?php if (isset($_SESSION['mensaje'])): ?>
    <div id="alert-box" style="padding: 15px; text-align: center; font-weight: bold; font-family: 'Montserrat', sans-serif; transition: all 0.5s ease; background-color: <?php echo ($_SESSION['tipo_mensaje'] == 'success') ? '#d4edda' : (($_SESSION['tipo_mensaje'] == 'error') ? '#f8d7da' : '#d1ecf1'); ?>; color: <?php echo ($_SESSION['tipo_mensaje'] == 'success') ? '#155724' : (($_SESSION['tipo_mensaje'] == 'error') ? '#721c24' : '#0c5460'); ?>; border-bottom: 2px solid rgba(0,0,0,0.1);">
        <?php
